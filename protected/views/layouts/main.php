		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Связь с администрацией', 'url'=>array('/site/contact')),
                                ...
                                array('label'=>'Тестирование', 'url'=>array('/testirovanie/index'),'view'=>'tests','visible'=> !Yii::app()->user->isGuest&& (Users::curentRoles(Yii::app()->user->id)==2)),    
                            ...
                            array('label'=>'Добавить дисциплину', 'url'=>array('/category/index'), 'views'=>'test','visible'=> !Yii::app()->user->isGuest&& (Users::curentRoles(Yii::app()->user->id)==0)),
