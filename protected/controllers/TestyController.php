...
//	}
	...
	{
		$dataProvider=new CActiveDataProvider('Testy');
	...
	{
		$model=new Testy('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Testy']))
			$model->attributes=$_GET['Testy'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='testy-form')
		{
